let data = [

    {
        ...
        username: 'alex98',
        islastseen: '12:21',
        img: 'images/Akmalxon.jpg',
        text: 'How are you doing ?',
        chatdata: ['Salom Akmal', 'Akmal qachon kelasiz'],
    ...
    },
    {
        ...
        username: 'umidjob@94',
        islastseen: '07:21',
        img: 'images/umijonAka.jpg',
        text: 'Umidjon aka is typing ...',
        chatdata: ['Salom Umidjon aka', ' qachon kelasiz']
    },

    {
        ...
        username: 'beka@98',
        islastseen: 'online',
        img: 'images/beka98.jpg',
        text: 'Bekzod is typing ...',
        chatdata: ['Dosm', 'Yaxshimizsiz ?', "Hi", 'Hello']
    },
    {
        id: 4,
        name: 'Farohiddin',
        username: 'farohiddin@2002',
        islastseen: '12:21',
        img: 'images/farohiddin.jpg',
        text: 'How are you doing ?',
        chatdata: ['Nima gap uka', ' qadasiz qachon kelasiz']
    },
    {
        id: 5,
        name: 'Bot Father',
    ...
    },
    {
        ...
        username: 'doston@',
        islastseen: '12:21',
        img: 'images/Dostonbek.jpg',
        text: 'How are you doing ?',
        chatdata: ['Tuzimisiz Dostonbek', ' qadasiz ']
    },
    {
        id: 9,
        name: 'Muhammaddiyor',
...
KunTun.addEventListener('click', (event) => {
    if (event.target.checked) {
        document.getElementById('mySidenav').style.background = '#18222C';
        document.getElementById('topdiv').style.backgroundColor = '#070B11';
        document.getElementById('all-words').style.color = 'white';
        document.getElementById('mySidenav').style.color = 'white';
    } else {
        document.getElementById('mySidenav').style.backgroundColor = 'white';
        document.getElementById('topdiv').style.backgroundColor = '#568BB4';
        document.getElementById('topdiv').style.color = 'white';
        document.getElementById('all-words').style.color = 'white';
